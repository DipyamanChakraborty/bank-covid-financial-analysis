Comparative Financial Impact Analysis: SBI vs HDFC (FY18–FY25)

Project Overview:

This project analyzes the financial performance of State Bank of India (SBI) and HDFC Bank from FY2018 to FY2025, with a focus on understanding how each bank was impacted before, during, and after the COVID-19 period.
The objective was not only to compare performance metrics, but to understand structural differences in profitability, risk management, balance sheet strength, and growth strategy across different economic phases.
...
- Net Profit (Year-wise and Phase-wise)
- YoY Net Profit Growth (%)
- Gross NPA (%)
- Risk Buffer (CAR − Net NPA)
- Advances to Deposits Ratio
- Total Assets Growth
- CAGR (Net Profit)

Phase-Based Financial Understanding:

The study period was divided into structured phases:
- PRE-COVID (FY18–FY20)
- COVID SHOCK (FY21)
- RECOVERY (FY22)
